...
import ua.nure.hrynko.SummaryTask4.db.dao.interfaces.OrderDAO;
...
public class MySqlOrdersDAO implements OrderDAO {
    private static final Logger LOG = Logger.getLogger(MySqlOrdersDAO.class);
